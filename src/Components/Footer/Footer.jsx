...
const Footer = () => {
  return (
    <div id="Contact" className="p-10 md:p-24 bg-gradient-to-br from-black via-gray-900 to-black min-h-screen text-white rounded-t-3xl flex flex-col items-center justify-center gap-10">
      {/* Heading */}
      ...
      <div className="bg-[#1f2937] p-6 rounded-2xl w-full max-w-md">
